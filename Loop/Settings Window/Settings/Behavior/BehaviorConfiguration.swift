...
struct BehaviorConfigurationView: View {
    ...
    @Default(.useAvailableSpaceForSidePlacement) var useAvailableSpaceForSidePlacement
    ...
    private var windowSection: some View {
        LuminareSection(String(localized: "Window", comment: "Section header shown in settings")) {
            ...
            LuminareToggle(
                "Use occupied space for side placement",
                isOn: $useAvailableSpaceForSidePlacement
            )
        }
    }
